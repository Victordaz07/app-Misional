...
export default function QuizLesson5() {
    ...
    const originalQuestions: QuizQuestion[] = [
        {
            id: "q1",
            question: t("quiz.lesson5.question1"),
            options: [
                t("quiz.lesson5.question1.option1"),
                t("quiz.lesson5.question1.option2"),
                t("quiz.lesson5.question1.option3"),
                t("quiz.lesson5.question1.option4"),
            ],
            correctAnswer: parseInt(t("quiz.lesson5.question1.correct")),
            originalCorrectAnswer: parseInt(t("quiz.lesson5.question1.correct")),
        },
        {
            id: "q2",
            question: t("quiz.lesson5.question2"),
            options: [
                t("quiz.lesson5.question2.option1"),
                t("quiz.lesson5.question2.option2"),
                t("quiz.lesson5.question2.option3"),
                t("quiz.lesson5.question2.option4"),
            ],
            correctAnswer: parseInt(t("quiz.lesson5.question2.correct")),
            originalCorrectAnswer: parseInt(t("quiz.lesson5.question2.correct")),
        },
        {
            id: "q3",
            question: t("quiz.lesson5.question3"),
            options: [
                t("quiz.lesson5.question3.option1"),
                t("quiz.lesson5.question3.option2"),
                t("quiz.lesson5.question3.option3"),
                t("quiz.lesson5.question3.option4"),
            ],
            correctAnswer: parseInt(t("quiz.lesson5.question3.correct")),
            originalCorrectAnswer: parseInt(t("quiz.lesson5.question3.correct")),
        },
    ];
        ...
        return (
            <View style={styles.resultsContainer}>
                <View style={styles.resultsHeader}>
                    ...
                    <Text style={styles.resultsSubtitle}>Resultados de la Lección 5: Leyes y Ordenanzas</Text>
                </View>
        ...
        <SafeAreaView style={[styles.safeArea, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
            ...
            >
                <View style={styles.lessonHeader}>
                    <Text style={styles.lessonTitle}>Lección 5: Leyes y Ordenanzas</Text>
