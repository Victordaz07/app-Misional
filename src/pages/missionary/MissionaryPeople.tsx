      ...
      <div className="page-content">
        ...
        {showAddForm && (
          <div className="people-form">
            ...
            <div className="form-group">
              <label>{t('missionary.people.status') || 'Estado'}</label>
              <select
                value={newPerson.status || 'new'}
                onChange={(e) => setNewPerson({ ...newPerson, status: e.target.value as Person['status'] })}
              >
                <option value="new">{t('missionary.people.statusNew') || 'Nuevo'}</option>
                <option value="progress">{t('missionary.people.statusProgress') || 'En Progreso'}</option>
                <option value="ready">{t('missionary.people.statusReady') || 'Listo para Bautismo'}</option>
                <option value="baptized">{t('missionary.people.statusBaptized') || 'Bautizado'}</option>
              </select>
            </div>
            <div className="form-group">
              ...
              <div key={person.id} className="people-card">
                <div className="people-card-header">
                  ...
                  <div className="people-card-actions">
                    <select
                      value={person.status}
                      onChange={(e) => updatePersonStatus(person.id, e.target.value as Person['status'])}
                      className="status-select"
                    >
                      <option value="new">{t('missionary.people.statusNew') || 'Nuevo'}</option>
                      <option value="progress">{t('missionary.people.statusProgress') || 'En Progreso'}</option>
                      <option value="ready">{t('missionary.people.statusReady') || 'Listo'}</option>
                      <option value="baptized">{t('missionary.people.statusBaptized') || 'Bautizado'}</option>
                    </select>
                    <button
